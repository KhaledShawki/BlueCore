...
```cmd
python scripts\blue.py premake vs2026 --toolchain=msvc --blue-platforms=windows --msvc-toolset=v143
```
...
```cmd
python scripts\blue.py premake vs2022 --toolchain=msvc --blue-platforms=windows --blue-startup=BlueRunTests
```
