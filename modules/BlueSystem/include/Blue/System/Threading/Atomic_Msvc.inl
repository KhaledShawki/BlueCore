...
struct AtomicPrimitive< TStorage, 1, Kind >
{
  ...
  {
    const char result =
      _InterlockedCompareExchange8( reinterpret_cast< volatile char* >( const_cast< TStorage* >( value ) ), 0, 0 );
...
struct AtomicPrimitive< TStorage, 2, Kind >
{
  ...
  {
    const short result =
      _InterlockedCompareExchange16( reinterpret_cast< volatile short* >( const_cast< TStorage* >( value ) ), 0, 0 );
    return static_cast< TStorage >( result );
  }
...
struct AtomicPrimitive< TStorage, 4, Kind >
{
  static BLUE_FORCE_INLINE TStorage Load( const TStorage* value, MemoryOrder ) noexcept
  {
    ...
    {
      void* result =
        _InterlockedCompareExchangePointer( reinterpret_cast< void* volatile* >( const_cast< TStorage* >( value ) ),
                                            nullptr,
                                            nullptr );
    ...
    {
      const long result =
        _InterlockedCompareExchange( reinterpret_cast< volatile long* >( const_cast< TStorage* >( value ) ), 0, 0 );
      return static_cast< TStorage >( result );
    }
  }
  ...
  static BLUE_FORCE_INLINE void Store( TStorage* value, TStorage desired, MemoryOrder ) noexcept
  {
    if constexpr ( Kind == AtomicKind::Pointer )
    {
      _InterlockedExchangePointer( reinterpret_cast< void* volatile* >( value ), reinterpret_cast< void* >( desired ) );
    }
    else
    {
...
struct AtomicPrimitive< TStorage, 8, Kind >
{
  static BLUE_FORCE_INLINE TStorage Load( const TStorage* value, MemoryOrder ) noexcept
  {
    ...
    else
    {
      const __int64 result =
        _InterlockedCompareExchange64( reinterpret_cast< volatile __int64* >( const_cast< TStorage* >( value ) ),
                                       0,
                                       0 );
      return static_cast< TStorage >( result );
    }
  ...
  static BLUE_FORCE_INLINE TStorage FetchAdd( TStorage* value, TStorage amount, MemoryOrder ) noexcept
  {
    static_assert( Kind == AtomicKind::SignedInteger || Kind == AtomicKind::UnsignedInteger );
    const __int64 result =
      _InterlockedExchangeAdd64( reinterpret_cast< volatile __int64* >( value ), static_cast< __int64 >( amount ) );
    return static_cast< TStorage >( result );
  }
