...
function bb.regeneration.build_manifest()
    ...
    table.insert(lines, "ClionConfig=" .. tostring(_OPTIONS["clion-config"] or "default"))
    table.insert(lines, "ClionPlatform=" .. tostring(_OPTIONS["clion-platform"] or "default"))
    table.insert(lines, "ClionIdea=" .. tostring(_OPTIONS["clion-idea"] or "on"))
    table.insert(lines, "ClionRunTargets=" .. tostring(_OPTIONS["clion-run-targets"] or "default"))
    table.insert(lines, "ClionBuildTargets=" .. tostring(_OPTIONS["clion-build-targets"] or "default"))
